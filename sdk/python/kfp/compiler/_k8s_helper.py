...
class K8sHelper(object):
    ...
    def _create_k8s_job(self, yaml_spec):
        ...
        container = k8s_client.V1Container(name=yaml_spec['spec']['containers'][0]['name'],
                                           ...
                                           volume_mounts=[k8s_client.V1VolumeMount(
                                               ...
                                               mount_path=yaml_spec['spec']['containers'][0]['volumeMounts'][0][
                                                   'mountPath'],
                                           )],
    ...
    def _delete_k8s_job(self, pod_name, yaml_spec):
        ...
        try:
            api_response = self._corev1.delete_namespaced_pod(pod_name, yaml_spec['metadata']['namespace'],
                                                              k8s_client.V1DeleteOptions())
        except k8s_client.rest.ApiException as e:
    ...
    def sanitize_k8s_name(name):
        """From _make_kubernetes_name  在工作流中转换名字
